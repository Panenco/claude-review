...
# origin/main tip, then point the floating major tag (`v3`) at the same commit.
...
#
#   scripts/release.sh v3.1.0            # publish
#   scripts/release.sh v3.1.0 --dry-run  # print the commands without pushing
