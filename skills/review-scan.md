...
- **A finding marked `author replied` owes that reply an answer**, quoted under it in `/tmp/prior-findings.md`. Re-posting it unaddressed is never allowed. One of three:
  - The reply names something you can check in the checkout and it holds → `resolved_prior`, that code as `evidence`.
